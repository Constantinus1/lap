...
import { LayoutGrid, Menu, Search, ShoppingBag, ShoppingCart } from 'lucide-vue-next';
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                ...
                                <div class="flex flex-col space-y-4">
                                    <Link v-for="item in rightNavItems" :key="item.title" :href="item.href"
                                        ...
                                        <TooltipTrigger>
                                            <Button variant="ghost" size="icon" as-child
                                                ...
                                                <Link :href="item.href">
                                                    ...
                                                    <span v-if="item.title === 'Shopping Cart' && cartCount > 0"
